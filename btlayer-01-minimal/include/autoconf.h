...
#define SQUID_CONFIGURE_OPTIONS " '--disable-build-info' '--disable-shared' '--disable-xmalloc-statistics' '--disable-async-io' '--disable-storeio' '--disable-disk-io' '--disable-removal-policies' '--disable-icmp' '--disable-delay-pools' '--disable-icap-client' '--disable-ecap' '--disable-useragent-log' '--disable-referer-log' '--disable-wccp' '--disable-wccpv2' '--disable-snmp' '--disable-eui' '--disable-htcp' '--disable-ssl-crtd' '--disable-forw-via-db' '--disable-cache-digests' '--disable-poll' '--disable-select' '--disable-kqueue' '--disable-epoll' '--disable-http-violations' '--disable-ipfw-transparent' '--disable-ipf-transparent' '--disable-pf-transparent' '--disable-linux-netfilter' '--disable-linux-tproxy' '--disable-follow-x-forwarded-for' '--disable-default-hostsfile' '--disable-auth' '--disable-basic-auth-helpers' '--disable-ntlm-auth-helpers' '--disable-negotiate-auth-helpers' '--disable-digest-auth-helpers' '--disable-ntlm-fail-open' '--disable-external-acl-helpers' '--disable-url-rewrite-helpers' '--disable-mempools' '--disable-win32-service' '--disable-unlinkd' '--disable-stacktraces' '--disable-cpu-profiling' '--disable-vary' '--disable-ipv6' '--disable-zph-qos' '--disable-auto-locale' '--disable-translation' '--disable-optimizations' '--without-pthreads' '--without-aio' '--without-cap' '--without-dl' '--without-gnugss' '--without-heimdal-krb5' '--without-large-files' '--without-ldap' '--without-mit-krb5' '--without-nettle' '--without-valgrind-debug' '--without-ipv6-split-stack' '--without-dns-cname' '--without-gnutls' '--without-openssl' '--without-po2html' '--without-psapi' '--without-systemd' '--without-tdb'"
