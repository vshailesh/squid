...
#define SQUID_CONFIGURE_OPTIONS " '--enable-shared' '--enable-optimizations' '--enable-xmalloc-statistics' '--enable-async-io' '--enable-storeio' '--enable-disk-io' '--enable-removal-policies' '--enable-icmp' '--enable-delay-pools' '--enable-icap-client' '--enable-useragent-log' '--enable-referer-log' '--enable-wccp' '--enable-wccpv2' '--enable-snmp' '--enable-eui' '--enable-htcp' '--enable-forw-via-db' '--enable-cache-digests' '--enable-poll' '--enable-select' '--enable-http-violations' '--enable-ipfw-transparent' '--enable-follow-x-forwarded-for' '--enable-default-hostsfile=/etc/hosts' '--enable-auth' '--enable-basic-auth-helpers' '--enable-ntlm-auth-helpers' '--enable-negotiate-auth-helpers' '--enable-digest-auth-helpers' '--enable-ntlm-fail-open' '--enable-external-acl-helpers' '--enable-url-rewrite-helpers' '--enable-mempools' '--enable-unlinkd' '--enable-stacktraces' '--enable-vary' '--enable-x-accelerator-vary' '--enable-ipv6' '--enable-auto-locale' '--enable-translation' '--enable-zph-qos' '--with-aio' '--with-build-environment=default' '--with-dl' '--with-dns-cname' '--with-gnu-ld' '--with-ipv6-split-stack' '--with-large-files' '--with-pic' '--with-pthreads' '--enable-build-info=squid test build' '--enable-ssl-crtd' '--with-openssl'"
